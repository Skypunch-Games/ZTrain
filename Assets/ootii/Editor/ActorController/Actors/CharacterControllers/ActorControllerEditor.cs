...
public class ActorControllerEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        // CDL 06/29/2018 - this only scans the the assembly containing ActorController
        ...
        // CDL 06/29/2018 - look in all assemblies for body shapes
        // Generate the list of body shapes to display
