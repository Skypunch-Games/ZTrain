...
namespace com.ootii.MotionControllerPacks
{
    ...
    public class BasicDeath : MotionControllerMotion
    {
        ...
        // CDL 07/01/2018 - this option ensures that a dead AI character doesn't
        // continue to follow or turn to face its target, which happens not infrequently
        /// <summary>
        /// Determines if we disable the NavMeshAgent (if present)
        /// </summary>
        public bool _DisableNavMeshAgent = true;
        public bool DisableNavMeshAgent
        {
            get { return _DisableNavMeshAgent; }
            set { _DisableNavMeshAgent = value; }
        }
