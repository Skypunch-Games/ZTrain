...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class BasicWalkRunStrafe : MotionControllerMotion, IWalkRunMotion, IStrafeMotion
    {
        /// <summary>
        ...
        public override void Update(float rDeltaTime, int rUpdateIndex)
        {
            ...
            {
                int lHash = Animator.StringToHash("Base Layer.BasicWalkRunStrafe-SM.Unarmed BlendTree");
