...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Vault_1m : MotionControllerMotion
    {
        ...
        public override void OnSettingsGUI()
        {
            ...
            mWalkVault_1m = CreateAnimationField("WalkVault_1m", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/unity_WalkJump_ToLeft_R_2.fbx/WalkVault_1m.anim", "WalkVault_1m", mWalkVault_1m);
            mWalkForward = CreateAnimationField("WalkForward", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_WalkFWD.fbx/WalkForward.anim", "WalkForward", mWalkForward);
            mRunVault_1m = CreateAnimationField("RunVault_1m", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/unity_RunJump_ToLeft_4.fbx/RunVault_1m.anim", "RunVault_1m", mRunVault_1m);
            mRunForward = CreateAnimationField("RunForward", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_JogForward_NtrlFaceFwd.fbx/RunForward.anim", "RunForward", mRunForward);
