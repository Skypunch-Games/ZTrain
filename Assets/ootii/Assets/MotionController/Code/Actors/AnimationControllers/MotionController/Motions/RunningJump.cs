...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class RunningJump : MotionControllerMotion
    {
        ...
        {
            m17118 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdlePose.anim", "IdlePose");
            m17050 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/RunForward_v2.fbx/RunForward.anim", "RunForward");
            m22024 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_RunningJump.fbx/RunningJump.anim", "RunningJump");
            m20978 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/LandToIdle.anim", "LandToIdle");
        ...
        public override void OnSettingsGUI()
        {
            ...
            m17118 = CreateAnimationField("Start.IdlePose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdlePose.anim", "IdlePose", m17118);
            m17050 = CreateAnimationField("RunJump_RunForward.RunForward", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/RunForward_v2.fbx/RunForward.anim", "RunForward", m17050);
            m22024 = CreateAnimationField("RunningJump", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_RunningJump.fbx/RunningJump.anim", "RunningJump", m22024);
            m20978 = CreateAnimationField("LandToIdle", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/LandToIdle.anim", "LandToIdle", m20978);
