    ...
    public class ClimbWall : MotionControllerMotion
    {
        ...
        public override void Update(float rDeltaTime, int rUpdateIndex)
        {
            ...
            else if (lStateID == STATE_ScaleWallDown)
            {
                ...
                if (mIsExitTriggered)
                {
                    if (mActorController.State.Ground != null && mActorController.State.GroundSurfaceDirectDistance > 0.2f)
                    {
                        mIsExitTriggered = false;
                    }
                }
        ...
        public override void OnSettingsGUI()
        {
            ...
            mScaleWallBottomOn = CreateAnimationField("ScaleWallBottomOn", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ScaleWall.fbx/ScaleWallBottomOn.anim", "ScaleWallBottomOn", mScaleWallBottomOn);
            mScaleWallUpLoop = CreateAnimationField("ScaleWallUp", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ScaleWall.fbx/ScaleWallUpLoop.anim", "ScaleWallUpLoop", mScaleWallUpLoop);
            mScaleWallDownLoop = CreateAnimationField("ScaleWallDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ScaleWall.fbx/ScaleWallDownLoop.anim", "ScaleWallDownLoop", mScaleWallDownLoop);
            mScaleWallBottomOff = CreateAnimationField("ScaleWallBottomOff", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ScaleWall.fbx/ScaleWallBottomOff.anim", "ScaleWallBottomOff", mScaleWallBottomOff);
            mScaleWallPose = CreateAnimationField("ScaleWallPose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ScaleWall.fbx/ScaleWallPose.anim", "ScaleWallPose", mScaleWallPose);
            ...
            mPullUpToIdle = CreateAnimationField("ClimbToIdle", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/unity_Idle_JumpUpMedium_2Hands_Idle.fbx/PullUpToIdle.anim", "PullUpToIdle", mPullUpToIdle);
            ...
            mJumpToClimb = CreateAnimationField("JumpToClimb", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/mix_jumping_to_hanging.fbx/JumpToClimb.anim", "JumpToClimb", mJumpToClimb);
