...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Jump : MotionControllerMotion
    {
        ...
        public override void OnSettingsGUI()
        {
            ...
            mIdleToRise = CreateAnimationField("JumpRise", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/IdleToRise.anim", "IdleToRise", mIdleToRise);
            mFallToLand = CreateAnimationField("JumpLand", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/FallToLand.anim", "FallToLand", mFallToLand);
            mRisePose = CreateAnimationField("JumpRisePose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/RisePose.anim", "RisePose", mRisePose);
            mFall = CreateAnimationField("JumpFallPose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/Fall.anim", "Fall", mFall);
            mTopToFall = CreateAnimationField("JumpTopToFall", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/TopToFall.anim", "TopToFall", mTopToFall);
            mRiseToTop = CreateAnimationField("JumpRiseToTop", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/RiseToTop.anim", "RiseToTop", mRiseToTop);
            mTopPose = CreateAnimationField("JumpTopPose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/TopPose.anim", "TopPose", mTopPose);
            mLandToIdle = CreateAnimationField("JumpRecoverIdle", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/LandToIdle.anim", "LandToIdle", mLandToIdle);
            mLandToRun2 = CreateAnimationField("JumpRecoverRun", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Jumping/ootii_Jump.fbx/LandToRun2.anim", "LandToRun2", mLandToRun2);
