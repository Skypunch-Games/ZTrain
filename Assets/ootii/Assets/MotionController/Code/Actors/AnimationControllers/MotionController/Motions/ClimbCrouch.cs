...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class ClimbCrouch : MotionControllerMotion
    {
        ...
        public override void OnSettingsGUI()
        {
            ...
            mClimbCrouchPose = CreateAnimationField("ClimbCrouchPose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/ClimbCrouchPose.anim", "ClimbCrouchPose", mClimbCrouchPose);
            mIdleToClimbCrouch = CreateAnimationField("IdleToClimbCrouch", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/IdleToClimbCrouch.anim", "IdleToClimbCrouch", mIdleToClimbCrouch);
            mClimbCrouchToIdle = CreateAnimationField("ClimbCrouchToTop", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/ClimbCrouchToIdle.anim", "ClimbCrouchToIdle", mClimbCrouchToIdle);
            mJumpRiseToClimbCrouch = CreateAnimationField("JumpRiseToClimbCrouch", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/JumpRiseToClimbCrouch.anim", "JumpRiseToClimbCrouch", mJumpRiseToClimbCrouch);
            mJumpFallToClimbCrouch = CreateAnimationField("JumpFallToClimbCrouch", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/JumpFallToClimbCrouch.anim", "JumpFallToClimbCrouch", mJumpFallToClimbCrouch);
            mClimbCrouchToJumpFall = CreateAnimationField("ClimbCrouchToJumpFall", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/ClimbCrouchToJumpFall.anim", "ClimbCrouchToJumpFall", mClimbCrouchToJumpFall);
            mJumpTopToClimbCrouch = CreateAnimationField("JumpTopToClimbCrouch", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/JumpTopToClimbCrouch.anim", "JumpTopToClimbCrouch", mJumpTopToClimbCrouch);
            mClimbCrouchRecoverIdle = CreateAnimationField("ClimbCrouchRecoverIdle", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouch.fbx/ClimbCrouchRecoverIdle.anim", "ClimbCrouchRecoverIdle", mClimbCrouchRecoverIdle);
            mShimmyRight = CreateAnimationField("ClimbCrouchShimmyRight", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouchShimmy.fbx/ShimmyRight.anim", "ShimmyRight", mShimmyRight);
            mShimmyLeft = CreateAnimationField("ClimbCrouchShimmyLeft", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Climbing/ootii_ClimbCrouchShimmy.fbx/ShimmyLeft.anim", "ShimmyLeft", mShimmyLeft);
