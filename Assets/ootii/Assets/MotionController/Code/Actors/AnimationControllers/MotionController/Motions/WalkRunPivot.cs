...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class WalkRunPivot : MotionControllerMotion, IWalkRunMotion, IPivotMotion
    {
        /// <summary>
        ...
        public override void OnSettingsGUI()
        {
            ...
            mIdleToWalk = CreateAnimationField("IdleToWalk", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_WalkForward_NtrlFaceFwd.fbx/IdleToWalk.anim", "IdleToWalk", mIdleToWalk);
            mIdleToRun = CreateAnimationField("IdleToRun", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_JogForward_NtrlFaceFwd.fbx/IdleToRun.anim", "IdleToRun", mIdleToRun);
            mIdleTurn90L = CreateAnimationField("IdleTurn90L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleTurn90L.anim", "IdleTurn90L", mIdleTurn90L);
            mIdleTurn180L = CreateAnimationField("IdleTurn180L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleTurn180L.anim", "IdleTurn180L", mIdleTurn180L);
            mIdleToWalk90L = CreateAnimationField("IdleToWalk90L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/IdleToWalk90L.anim", "IdleToWalk90L", mIdleToWalk90L);
            mIdleToWalk180L = CreateAnimationField("IdleToWalk180L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/IdleToWalk180L.anim", "IdleToWalk180L", mIdleToWalk180L);
            mIdleToRun90L = CreateAnimationField("IdleToRun90L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_Idle2Run_AllAngles.fbx/IdleToRun90L.anim", "IdleToRun90L", mIdleToRun90L);
            mIdleToRun180L = CreateAnimationField("IdleToRun180L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_Idle2Run_AllAngles.fbx/IdleToRun180L.anim", "IdleToRun180L", mIdleToRun180L);
            mIdleTurn90R = CreateAnimationField("IdleTurn90R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleTurn90R.anim", "IdleTurn90R", mIdleTurn90R);
            mIdleTurn180R = CreateAnimationField("IdleTurn180R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleTurn180R.anim", "IdleTurn180R", mIdleTurn180R);
            mIdleToWalk90R = CreateAnimationField("IdleToWalk90R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/IdleToWalk90R.anim", "IdleToWalk90R", mIdleToWalk90R);
            mIdleToWalk180R = CreateAnimationField("IdleToWalk180R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/IdleToWalk180R.anim", "IdleToWalk180R", mIdleToWalk180R);
            mIdleToRun90R = CreateAnimationField("IdleToRun90R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_Idle2Run_AllAngles.fbx/IdleToRun90R.anim", "IdleToRun90R", mIdleToRun90R);
            mIdleToRun180R = CreateAnimationField("IdleToRun180R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_Idle2Run_AllAngles.fbx/IdleToRun180R.anim", "IdleToRun180R", mIdleToRun180R);
            ...
            mWalkForward = CreateAnimationField("WalkFwdLoop", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_WalkFWD.fbx/WalkForward.anim", "WalkForward", mWalkForward);
            mRunForward = CreateAnimationField("RunFwdLoop", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_JogForward_NtrlFaceFwd.fbx/RunForward.anim", "RunForward", mRunForward);
            mRunPivot180L_RDown = CreateAnimationField("RunPivot180L_RDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_PlantNTurn180_Run_R_1.fbx/RunPivot180L_RDown.anim", "RunPivot180L_RDown", mRunPivot180L_RDown);
            mRunPivot180R_LDown = CreateAnimationField("RunPivot180R_LDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_PlantNTurn180_Run_R_1.fbx/RunPivot180R_LDown.anim", "RunPivot180R_LDown", mRunPivot180R_LDown);
            mWalkToIdle_RDown = CreateAnimationField("WalkToIdle_RDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/WalkToIdle_RDown.anim", "WalkToIdle_RDown", mWalkToIdle_RDown);
            mWalkToIdle_LDown = CreateAnimationField("WalkToIdle_LDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/WalkToIdle_LDown.anim", "WalkToIdle_LDown", mWalkToIdle_LDown);
            mRunToIdle_RDown = CreateAnimationField("RunStop_RDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_HalfSteps2Idle_PasingLongStepTOIdle.fbx/RunToIdle_RDown.anim", "RunToIdle_RDown", mRunToIdle_RDown);
            mRunToIdle_LDown = CreateAnimationField("RunStop_LDown", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Running/unity_PlantNTurn180_Run_R_2.fbx/RunToIdle_LDown.anim", "RunToIdle_LDown", mRunToIdle_LDown);
            mIdleTurn20R = CreateAnimationField("IdleTurn20R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleTurn20R.anim", "IdleTurn20R", mIdleTurn20R);
            mIdleTurn20L = CreateAnimationField("IdleTurn20L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleTurn20L.anim", "IdleTurn20L", mIdleTurn20L);
            mWalkPivot180L = CreateAnimationField("WalkPivot180L", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/WalkPivot180L.anim", "WalkPivot180L", mWalkPivot180L);
            mWalkPivot180R = CreateAnimationField("WalkPivot180R", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Walking/unity_Idle2walk_AllAngles.fbx/WalkPivot180R.anim", "WalkPivot180R", mWalkPivot180R);
