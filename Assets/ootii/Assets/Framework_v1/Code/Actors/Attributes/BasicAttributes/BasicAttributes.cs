...
namespace com.ootii.Actors.Attributes
{
    ...
    public class BasicAttributes : MonoBehaviour, IAttributeSource
    {
        ...
        /// <summary>
        /// Based on the Unity documentation, this function forces the compiler to generate
        /// functions for our specific type. Doing this avoids the 'no AOT code was generated' error.
        /// 
        /// https://docs.unity3d.com/Manual/ScriptingRestrictions.html
        /// </summary>
        public void UsedOnlyForAOTCodeGeneration()
        {
            GetAttribute<BasicAttributeBool>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", true);
            SetAttributeValue("OOTII_AOT", true);

            GetAttribute<BasicAttributeFloat>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", 0f);
            SetAttributeValue("OOTII_AOT", 0f);

            GetAttribute<BasicAttributeGameObject>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", (GameObject)null);
            SetAttributeValue("OOTII_AOT", (GameObject)null);

            GetAttribute<BasicAttributeInt>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", 1);
            SetAttributeValue("OOTII_AOT", 1);

            GetAttribute<BasicAttributeQuaternion>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", Quaternion.identity);
            SetAttributeValue("OOTII_AOT", Quaternion.identity);

            GetAttribute<BasicAttributeString>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", "");
            SetAttributeValue("OOTII_AOT", "");

            GetAttribute<BasicAttributeTag>("OOTII_AOT");

            GetAttribute<BasicAttributeTransform>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", (Transform)null);
            SetAttributeValue("OOTII_AOT", (Transform)null);

            GetAttribute<BasicAttributeVector2>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", Vector2.zero);
            SetAttributeValue("OOTII_AOT", Vector2.zero);

            GetAttribute<BasicAttributeVector3>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", Vector3.zero);
            SetAttributeValue("OOTII_AOT", Vector3.zero);

            GetAttribute<BasicAttributeVector4>("OOTII_AOT");
            GetAttributeValue("OOTII_AOT", Vector4.zero);
            SetAttributeValue("OOTII_AOT", Vector4.zero);
