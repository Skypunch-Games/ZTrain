                    ...
                    if (evt.type == EventType.DragPerform)
                    {
                        ...
                        foreach (Object draggedObject in DragAndDrop.objectReferences)
                        {
                            if (draggedObject.GetType() == selectedType)
                            {
                                ...
                                {
                                    case DropZoneType.GrassTexture:
                                        vegetationSystem.CurrentVegetationPackage.AddVegetationItem(draggedObject as Texture2D, VegetationType.Grass, true);
                                        break;
                                    case DropZoneType.PlantTexture:
                                        vegetationSystem.CurrentVegetationPackage.AddVegetationItem(draggedObject as Texture2D, VegetationType.Plant, true);
                                        break;
                                    case DropZoneType.GrassPrefab:
