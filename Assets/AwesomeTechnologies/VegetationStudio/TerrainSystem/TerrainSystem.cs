    ...
    public class TerrainSystem : MonoBehaviour
    {
        ...
        public Texture2D GetTerrainTexture(int index)
        {
            ...
            if (VegetationSystem.currentTerrain)
            {
                ...
                if (index < VegetationSystem.currentTerrain.terrainData.terrainLayers.Length)
                {
                        return VegetationSystem.currentTerrain.terrainData.terrainLayers[index].diffuseTexture;                
                }
#else
