...
{
    public class TerrainDetailImporter : IVegetationImporter
    {
        ...
        private void ImportDetails(List<Texture2D> textureList)
        {
            ...
            for (int i = 0; i <= textureList.Count - 1; i++)
            {
                ...
                string vegetationItemId = VegetationPackage.AddVegetationItem(textureList[i], VegetationType.Grass, false);
