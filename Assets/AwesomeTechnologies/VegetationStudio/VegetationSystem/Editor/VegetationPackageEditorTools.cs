...
public class VegetationPackageEditorTools
{
    ...
    public static List<string> CreateVegetationInfoIdList(VegetationPackage vegetationPackage)
    {
    ...
    public static List<string> CreateVegetationInfoIdList(VegetationPackage vegetationPackage, VegetationType[] vegetationTypes)
    {
        List<string> resultList = new List<string>();
    ...
    public static void DrawVegetationItemSelector(VegetationPackage vegetationPackage, List<string> vegetationInfoIdList, int imageSize, ref string selectedVegetationItemId)
    {
        ...
        {
            VegetationItemInfo vegetationItemInfo = vegetationPackage.GetVegetationInfo(vegetationInfoIdList[i]);
    ...
    static void DrawSelectedName(string vegetationItemID, VegetationPackage vegetationPackage)
    {
        if (vegetationItemID != "")
        {
    ...
    public static void DrawVegetationItemSelector(VegetationPackage vegetationPackage, ref int selectedGridIndex, ref int vegIndex, ref int selectionCount,VegetationItemTypeSelection vegetationItemTypeSelection, int imageSize)
    {
