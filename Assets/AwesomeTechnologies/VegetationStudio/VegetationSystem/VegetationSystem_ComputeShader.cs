...
namespace AwesomeTechnologies
{
    ...
    public partial class VegetationSystem
    {
        ...
        private int _visibleShadowBufferLod0ID = -1;
        private int _visibleShadowBufferLod1ID = -1;
        private int _visibleShadowBufferLod2ID = -1;
        ...
        void SetupFrustumComputeShaders()
        {
            ...
            if (SystemInfo.supportsComputeShaders)
            {
                ...
                _visibleShadowBufferLod0ID = Shader.PropertyToID("VisibleShadowBufferLOD0");
                _visibleShadowBufferLod1ID = Shader.PropertyToID("VisibleShadowBufferLOD1");
                _visibleShadowBufferLod2ID = Shader.PropertyToID("VisibleShadowBufferLOD2");
        ...
        void DrawCellsIndirectComputeShader()
        {
            ...
            for (int i = 0; i <= VegetationModelInfoList.Count - 1; i++)
            {
                ...
                {
                    FrusumMatrixShader.SetFloat("_CullFarStart", vegetationSettings.VegetationDistance + vegetationSettings.TreeDistance);
                    FrusumMatrixShader.SetFloat("_CullFarDistance", 0);
                }
                else
                {
                    FrusumMatrixShader.SetFloat("_CullFarStart", vegetationSettings.VegetationDistance);
                ...
                ShadowCastingMode shadowMode = GetVegetationShadowMode(vegetationItemInfo.VegetationType);
                bool useShadowCulling = false;
                if (vegetationItemInfo.VegetationType == VegetationType.Tree ||
                    vegetationItemInfo.VegetationType == VegetationType.LargeObjects)
                {
                    if (shadowMode == ShadowCastingMode.On)
                    {
                        useShadowCulling = true;
                    }
                }
                ...
                if (useShadowCulling)
                {
                    ...
                    {
                        VegetationCell vegetationCell = ProcessVegetationCellList[j];
                ...
                VegetationModelInfoList[i].VisibleShadowBufferLOD0.SetCounterValue(0);
                VegetationModelInfoList[i].VisibleShadowBufferLOD1.SetCounterValue(0);
                VegetationModelInfoList[i].VisibleShadowBufferLOD2.SetCounterValue(0);
                ...
                if (UseGPUCulling)
                {
                    ...
                    FrusumMatrixShader.SetBuffer(FrustumKernelHandle, _visibleShadowBufferLod0ID, VegetationModelInfoList[i].VisibleShadowBufferLOD0);
                    FrusumMatrixShader.SetBuffer(FrustumKernelHandle, _visibleShadowBufferLod1ID, VegetationModelInfoList[i].VisibleShadowBufferLOD1);
                    FrusumMatrixShader.SetBuffer(FrustumKernelHandle, _visibleShadowBufferLod2ID, VegetationModelInfoList[i].VisibleShadowBufferLOD2);
                    ...
                    FrusumMatrixShader.SetVector(_lightDirection, lightDirection);
                    FrusumMatrixShader.SetVector(_planeOrigin, planeOrigin);
                    FrusumMatrixShader.SetVector(_boundsSize, vegetationItemInfo.Bounds.size);              
                ...
                else
                {
                    ...
                    FrusumMatrixShader.SetBool(_shadowCullingID, false);
                    FrusumMatrixShader.SetVector(_lightDirection, lightDirection);
                    FrusumMatrixShader.SetVector(_planeOrigin, planeOrigin);
                    FrusumMatrixShader.SetVector(_boundsSize, vegetationItemInfo.Bounds.size);                                 
                ...
                if (useShadowCulling)
                {
                    for (int k = 0; k <= VegetationModelInfoList[i].VegetationMeshLod0.subMeshCount - 1; k++)
                    {
                        ComputeBuffer.CopyCount(VegetationModelInfoList[i].VisibleShadowBufferLOD0,
                            VegetationModelInfoList[i].ArgsBufferMergedShadowLOD0List[k], sizeof(uint) * 1);         
                    }

                    for (int k = 0; k <= VegetationModelInfoList[i].VegetationMeshLod1.subMeshCount - 1; k++)
                    {
                        ComputeBuffer.CopyCount(VegetationModelInfoList[i].VisibleShadowBufferLOD1,
                            VegetationModelInfoList[i].ArgsBufferMergedShadowLOD1List[k], sizeof(uint) * 1);
                    }

                    for (int k = 0; k <= VegetationModelInfoList[i].VegetationMeshLod2.subMeshCount - 1; k++)
                    {
                        ComputeBuffer.CopyCount(VegetationModelInfoList[i].VisibleShadowBufferLOD2,
                            VegetationModelInfoList[i].ArgsBufferMergedShadowLOD2List[k], sizeof(uint) * 1);
                    }   
                }            
                ...
                if (UseIndirectLoDs)
                {
                    DrawMergedVegetationCellBuffer(i, VegetationModelInfoList[i].VisibleBufferLOD0, VegetationModelInfoList[i].ArgsBufferMergedLOD0List, VegetationModelInfoList[i].VegetationMeshLod0, VegetationModelInfoList[i].VegetationMaterialsLOD0, VegetationModelInfoList[i].VegetationMaterialPropertyBlockLOD0, false);
                    DrawMergedVegetationCellBuffer(i, VegetationModelInfoList[i].VisibleBufferLOD1, VegetationModelInfoList[i].ArgsBufferMergedLOD1List, VegetationModelInfoList[i].VegetationMeshLod1, VegetationModelInfoList[i].VegetationMaterialsLOD1, VegetationModelInfoList[i].VegetationMaterialPropertyBlockLOD1, false);
                    DrawMergedVegetationCellBuffer(i, VegetationModelInfoList[i].VisibleBufferLOD2, VegetationModelInfoList[i].ArgsBufferMergedLOD2List, VegetationModelInfoList[i].VegetationMeshLod2, VegetationModelInfoList[i].VegetationMaterialsLOD2, VegetationModelInfoList[i].VegetationMaterialPropertyBlockLOD2, false);

                    if (useShadowCulling)
                    {
                        DrawMergedVegetationCellBuffer(i, VegetationModelInfoList[i].VisibleShadowBufferLOD0, VegetationModelInfoList[i].ArgsBufferMergedShadowLOD0List, VegetationModelInfoList[i].VegetationMeshLod0, VegetationModelInfoList[i].VegetationMaterialsLOD0, VegetationModelInfoList[i].VegetationMaterialPropertyBlockLOD0, true);
                        DrawMergedVegetationCellBuffer(i, VegetationModelInfoList[i].VisibleShadowBufferLOD1, VegetationModelInfoList[i].ArgsBufferMergedShadowLOD1List, VegetationModelInfoList[i].VegetationMeshLod1, VegetationModelInfoList[i].VegetationMaterialsLOD1, VegetationModelInfoList[i].VegetationMaterialPropertyBlockLOD1, true);
                        DrawMergedVegetationCellBuffer(i, VegetationModelInfoList[i].VisibleShadowBufferLOD2, VegetationModelInfoList[i].ArgsBufferMergedShadowLOD2List, VegetationModelInfoList[i].VegetationMeshLod2, VegetationModelInfoList[i].VegetationMaterialsLOD2, VegetationModelInfoList[i].VegetationMaterialPropertyBlockLOD2, true);
                    }
        ...
        void DrawMergedVegetationCellBuffer(int i, ComputeBuffer visibleBuffer, List<ComputeBuffer> argBufferList, Mesh mesh, Material[] materials, MaterialPropertyBlock mergedMaterialPropertyBlock, bool shadowsOnly)
        {
            ...
            if (shadowsOnly)
            {
                shadowMode = ShadowCastingMode.ShadowsOnly;
            }
