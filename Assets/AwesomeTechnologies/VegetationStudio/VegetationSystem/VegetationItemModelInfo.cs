...
namespace AwesomeTechnologies
{
    ...
    public class VegetationItemModelInfo
    {
        ...
        public ComputeBuffer VisibleShadowBufferLOD0;
        public ComputeBuffer VisibleShadowBufferLOD1;
        public ComputeBuffer VisibleShadowBufferLOD2;
        ...
        public List<ComputeBuffer> ArgsBufferMergedShadowLOD0List = new List<ComputeBuffer>();
        public List<ComputeBuffer> ArgsBufferMergedShadowLOD1List = new List<ComputeBuffer>();
        public List<ComputeBuffer> ArgsBufferMergedShadowLOD2List = new List<ComputeBuffer>();
        ...
        void CreateComputeBuffer()
        {
            ...
            VisibleShadowBufferLOD0 = new ComputeBuffer(5000, (16 * 4 * 2) + 16, ComputeBufferType.Append);
            VisibleShadowBufferLOD0.SetCounterValue(0);

            VisibleShadowBufferLOD1 = new ComputeBuffer(5000, (16 * 4 * 2) + 16, ComputeBufferType.Append);
            VisibleShadowBufferLOD1.SetCounterValue(0);

            VisibleShadowBufferLOD2 = new ComputeBuffer(5000, (16 * 4 * 2) + 16, ComputeBufferType.Append);
            VisibleShadowBufferLOD2.SetCounterValue(0);
            ...
            for (int i = 0; i <= VegetationMeshLod0.subMeshCount - 1; i++)
            {
                ...
                ComputeBuffer argsBufferMergedShadowLod0 =
                    new ComputeBuffer(1, _args.Length * sizeof(uint), ComputeBufferType.IndirectArguments);
                _args[0] = VegetationMeshLod0.GetIndexCount(i);
                _args[2] = VegetationMeshLod0.GetIndexStart(i);
                argsBufferMergedShadowLod0.SetData(_args);
                ArgsBufferMergedShadowLOD0List.Add(argsBufferMergedShadowLod0);
            ...
            for (int i = 0; i <= VegetationMeshLod1.subMeshCount - 1; i++)
            {
                ...
                ComputeBuffer argsBufferMergedShadowLod1 =
                    new ComputeBuffer(1, _args.Length * sizeof(uint), ComputeBufferType.IndirectArguments);
                _args[0] = VegetationMeshLod1.GetIndexCount(i);
                _args[2] = VegetationMeshLod1.GetIndexStart(i);
                argsBufferMergedShadowLod1.SetData(_args);
                ArgsBufferMergedShadowLOD1List.Add(argsBufferMergedShadowLod1);
            }
            ...
            for (int i = 0; i <= VegetationMeshLod2.subMeshCount - 1; i++)
            {
                ...
                ComputeBuffer argsBufferMergedShadowLod2 =
                    new ComputeBuffer(1, _args.Length * sizeof(uint), ComputeBufferType.IndirectArguments);
                _args[0] = VegetationMeshLod2.GetIndexCount(i);
                _args[2] = VegetationMeshLod2.GetIndexStart(i);
                argsBufferMergedShadowLod2.SetData(_args);
                ArgsBufferMergedShadowLOD2List.Add(argsBufferMergedShadowLod2);
            }
        }
        ...
        public void UpdateComputeBufferSize(int newInstanceCount)
        {
            ...
            if (VisibleShadowBufferLOD0 != null) VisibleShadowBufferLOD0.Release();
            VisibleShadowBufferLOD0 = null;

            if (VisibleShadowBufferLOD1 != null) VisibleShadowBufferLOD1.Release();
            VisibleShadowBufferLOD1 = null;

            if (VisibleShadowBufferLOD2 != null) VisibleShadowBufferLOD2.Release();
            VisibleShadowBufferLOD2 = null;
            ...
            VisibleShadowBufferLOD0 = new ComputeBuffer(newInstanceCount, (16 * 4 * 2) + 16, ComputeBufferType.Append);
            VisibleShadowBufferLOD0.SetCounterValue(0);

            VisibleShadowBufferLOD1 = new ComputeBuffer(newInstanceCount, (16 * 4 * 2) + 16, ComputeBufferType.Append);
            VisibleShadowBufferLOD1.SetCounterValue(0);

            VisibleShadowBufferLOD2 = new ComputeBuffer(newInstanceCount, (16 * 4 * 2) + 16, ComputeBufferType.Append);
            VisibleShadowBufferLOD2.SetCounterValue(0);
        }
        ...
        void ReleaseArgsBuffers()
        {
            ...
            for (int i = 0; i <= ArgsBufferMergedShadowLOD0List.Count - 1; i++)
            {
                if (ArgsBufferMergedShadowLOD0List[i] != null) ArgsBufferMergedShadowLOD0List[i].Release();
            }

            for (int i = 0; i <= ArgsBufferMergedShadowLOD1List.Count - 1; i++)
            {
                if (ArgsBufferMergedShadowLOD1List[i] != null) ArgsBufferMergedShadowLOD1List[i].Release();
            }

            for (int i = 0; i <= ArgsBufferMergedShadowLOD2List.Count - 1; i++)
            {
                if (ArgsBufferMergedShadowLOD2List[i] != null) ArgsBufferMergedShadowLOD2List[i].Release();
            }

            ArgsBufferMergedShadowLOD0List.Clear();
            ArgsBufferMergedShadowLOD1List.Clear();
            ArgsBufferMergedShadowLOD2List.Clear();            
        }
    }
}
