...
namespace Devdog.Rucksack.Characters
{
    public class InventoryPlayer : MonoBehaviour, IInventoryPlayer
    {
        ...
        {
            SetCollectionGroups();
            logger.LogVerbose($"Collection {key} changed. Updating player's collection groups.\n{itemCollectionGroup.collectionCount} inventories\n{equipmentCollectionGroup.collectionCount} equipment collections\n{currencyCollectionGroup.collectionCount} currency collections", this);
        }
