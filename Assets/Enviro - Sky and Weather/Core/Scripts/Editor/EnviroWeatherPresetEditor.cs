	...
	public override void OnInspectorGUI ()
	{
		...
		if (showClouds) {
            ...
            if (EnviroSkyMgr.instance == null || EnviroSkyMgr.instance.currentEnviroSkyVersion == EnviroSkyMgr.EnviroSkyVersion.HD)
            {
                ...
                myTarget.cloudsConfig.edgeDarkness = EditorGUILayout.Slider("In-Scattering Edge Darkness", myTarget.cloudsConfig.edgeDarkness, 1f, 5f);
                myTarget.cloudsConfig.density = EditorGUILayout.Slider("Density", myTarget.cloudsConfig.density, 1f, 50f);
                myTarget.cloudsConfig.densityLightning = EditorGUILayout.Slider("Lighting Density", myTarget.cloudsConfig.densityLightning, 1f, 25f);
